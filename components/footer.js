...
function footer() {
    ...
    <div id="footer">
        ...
        <div id="EXPERIENCE_MYNTRA_APP_ON_MOBILE">
          <h4>EXPERIENCE MYNTRA APP ON MOBILE</h4>
          <div id="first_EXPERIENCE_MYNTRA_APP_ON_MOBILE">
            <img
        ...
        <div id="last">
          <div>
            <img
              ...
              alt=""
            />
            <h3>100% ORIGINAL guarantee for all products at myntra.com</h3>
          </div>
          <div>
            <img
              ...
              alt=""
            />
            <h3>Return within 30days of receiving your order</h3>
          </div>
        </div>
      </div>
      ...
      <div id="POPULAR_SEARCHES">
        ...
        <p>
          ...
          Shoes| Reebok |Shoes | Puma | | Boxers| Wallets | Tops |Earrings |
      ...
      <div id="contact">
        ...
        <div>
          <h3>© 2022 www.myntra.com. All rights reserved.</h3>
        </div>
      </div>
      <hr />
        ...
        <div>
          ...
          <p>
            * Opportunity to master any domain in fashion with tips from
            celebrity stylists at Myntra Masterclass sessions. <br />
      ...
      <div id="myntr">
        ...
        <p>
          ...
          the overload of irrelevant information. <br />
          ...
          daily updates from your favourite fashion labels. <br />
      ...
      <div id="dia">
        <div>
          <h4>1. Keep Up With What Your Favourite Fashion Icons Are Upto</h4>
          <p>
            ...
            understanding trends and making suitable for daily wear. <br />
        ...
        <div>
          <h4>2. Quick Fashion Tip And Tricks</h4>
          <p>
        ...
        <div>
          <h4>3. Updates on What Is Trending and New Product Launches</h4>
          <p>
            ...
            as Puma, Coverstory, The Label Life and so many more. <br />
        ...
        <div>
          <h4>4. Explicit Step-By-Step Beauty Routines From Experts</h4>
          <p>
        ...
        <div>
          <h4>5. Celebrity Confessions And A Look Into Their Lives</h4>
          <p>
      ...
      <div id="history_of_myntra">
        ...
        <p>
          ...
          and tempting, hard-to-say-no-to deals. <br />
